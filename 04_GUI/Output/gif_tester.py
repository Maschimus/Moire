...
class GUI1(PARENTGUI):
   ...
   def __init_window(self):
          ...
          finishButton=Button(self,text="Finish",bg="red",font="Calibri 40 bold",fg="white",activebackground="white",highlightbackground="white",relief="raised",command=lambda:self.__show_preview())
          finishButton.place(x=500,y=400)
          backButton=Button(self,text="Back",bg="white",font="Calibri 12 bold",fg="red",relief="raised",command=lambda:self.__open_page3(self.values))
...
class GUI3(PARENTGUI):
      ...
      def __gif_animation(self,duration=10,loop=5,N_steps=5,roll_fac=4):
            ''' Takes
...
class GUI4(PARENTGUI):
      ...
      def __init__(self, values,master):
          ...
          self.text_inst="A simulated gif should open, if you want to see the gif again press Show again!! \n\n \par \par Have a nice day"
      ...
      def __init_window(self):
          ...
          T_i = Text(self.master, height=self.hight, width=self.width,font="Calibri 20",bg="white")
          T_i.insert(END, self.text_inst)
          T_i.place(x=self.x_pos,y=self.y_pos+self.hight)
      
          


          # Show again button
          showButton=Button(self, text='Show again',bg="white",font="Calibri 20 bold",fg="red",relief="raised", command=lambda:self.__show_gif_again())
          showButton.place(x=300,y=self.y_pos+3*self.hight)
  

          # Add botton finsih and back
          finishButton=Button(self,text="Close",bg="red",font="Calibri 40 bold",fg="white",activebackground="white",highlightbackground="white",relief="raised",command=lambda:self.__show_preview())
          finishButton.place(x=500,y=400)
          backButton=Button(self,text="Back",bg="white",font="Calibri 12 bold",fg="red",relief="raised",command=lambda:self.__open_page3(self.values))
